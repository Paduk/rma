...
def main(out_file):
    ...
    model_names = ['meta-llama-history-all_linear:latest', 'meta-llama-rewrite-all_linear:latest',
                 'gemma3-history-all_proj:latest', 'gemma3-rewrite-all_proj:latest',
                 'Phi-4-mini-instruct-history-1st:latest', 'Phi-4-mini-instruct-rewrite-1st:latest',
                 'Qwen2.5-3B-Instruct-history-all_linear:latest', 'Qwen2.5-3B-Instruct-rewrite-all_linear:latest',
                 'Qwen3-4B-history-1st:latest', 'Qwen3-4B-rewrite-1st:latest',
                 'Phi-4-mini-instruct-rewrite-rma-rewrite-integrated-1st:latest',
                 'Qwen3-1.7B-history-all_linear:latest', 'Qwen3-1.7B-rewrite-all_linear:latest',
                 'Qwen3-0.6B-history-all_linear:latest', 'Qwen3-0.6B-rewrite-all_linear:latest']

    model_prompts = {
        'meta-llama-history-all_linear:latest': SFT_HISTORY_INFERENCE_LLAMA,
        'meta-llama-rewrite-all_linear:latest': SFT_REWRITE_INFERENCE_LLAMA,        
        'gemma3-history-all_proj:latest': SFT_HISTORY_INFERENCE_GEMMA,
        'gemma3-rewrite-all_proj:latest': SFT_REWRITE_INFERENCE_GEMMA,
        ...
        'Qwen2.5-3B-Instruct-history-all_linear:latest': SFT_HISTORY_INFERENCE_QWEN25,
        'Qwen2.5-3B-Instruct-rewrite-all_linear:latest': SFT_REWRITE_INFERENCE_QWEN25,
        ...
        'Qwen3-1.7B-history-all_linear:latest': SFT_HISTORY_INFERENCE_QWEN3,
        'Qwen3-1.7B-rewrite-all_linear:latest': SFT_REWRITE_INFERENCE_QWEN3,
        'Qwen3-0.6B-history-all_linear:latest': SFT_HISTORY_INFERENCE_QWEN3,
        'Qwen3-0.6B-rewrite-all_linear:latest': SFT_REWRITE_INFERENCE_QWEN3,
    }

    #test_type = 'history'  # 'rewrite' or 'history'
    # python3 ollama_inference.py --o logs/weighted_rewrite --t rewrite
    # python3 ollama_inference.py --o logs/weighted_history --t history

    # python3 ollama_inference.py --t history-qwen3-0.6b --o datasets/result/qwen3-history-0.6b-complex.tsv
    # python3 ollama_inference.py --t rewrite-qwen3-0.6b --o datasets/result/qwen3-rewrite-0.6b-complex.tsv
    test_type = args.t
    if test_type == 'history-llama':
        ...
        prompt_template = model_prompts[model_name]
    elif test_type == 'history-qwen3-1.7b':
        model_name = model_names[11]
        prompt_template = model_prompts[model_name]
    elif test_type == 'rewrite-qwen3-1.7b':
        model_name = model_names[12]
        prompt_template = model_prompts[model_name]
    elif test_type == 'history-qwen3-0.6b':
        model_name = model_names[13]
        prompt_template = model_prompts[model_name]
    elif test_type == 'rewrite-qwen3-0.6b':
    ...
    test_key = 'rma_base' # 'rma_complex    
    # python3 ollama_inference.py --t rewrite-qwen3-0.6b --o datasets/result/rma-qwen3-0.6b-base.tsv && python3 ollama_inference.py --t rewrite-qwen3-0.6b --o datasets/result/rma-qwen3-0.6b-complex.tsv
    # python3 ollama_inference.py --t history-llama --o datasets/result/history-llama-base.tsv && python3 ollama_inference.py --t history-llama --o datasets/result/history-llama-complex.tsv
    data_files = {                        
        'base': [         
        ...
        'rma_base': [            
            'datasets/tc/phi-integrated-half_rewrited/it2_NR_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it2_nonNR_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it3_nonNR_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it4_nonNR_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it5_nonNR_tc.tsv',            
        ],
        'rma_complex': [                        
            'datasets/tc/phi-integrated-half_rewrited/it3_complex_1_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it4_complex_1_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it4_complex_2_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it5_complex_1_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it5_complex_2_tc.tsv',
            'datasets/tc/phi-integrated-half_rewrited/it5_complex_3_tc.tsv',                    
        ],
        'droidcall': [
