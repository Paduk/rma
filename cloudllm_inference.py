...
def main(out_file):
    ...
    tc_type = 'advanced_manual' # 'complex'
    # python3 cloudllm_inference.py --t rewrite --o logs/gpt41_it_all_re_rma.tsv    
    # python3 cloudllm_inference.py --model gpt-4o-mini-2024-07-18 --t rewrite --o datasets/manual/rewrite-cloud-gpt4o-mini.tsv
    # python3 cloudllm_inference.py --model gemini-2.0-flash --t rewrite --o datasets/manual/ad/rewrite-cloud-gemini-2.0-flash.tsv
    # python3 cloudllm_inference.py --model gemini-2.0-flash --t history --o datasets/manual/ad/history-cloud-gemini-2.0-flash.tsv
    # python3 cloudllm_inference.py --model gpt-4o-mini-2024-07-18 --t rewrite --o datasets/manual/ad/rewrite-cloud-gpt4o-mini.tsv
    # python3 cloudllm_inference.py --model gpt-4o-mini-2024-07-18 --t history --o datasets/manual/ad/history-cloud-gpt4o-mini.tsv
    # python3 cloudllm_inference.py --model gpt-4.1-2025-04-14 --t rewrite --o datasets/manual/ad/rewrite-cloud-gpt41.tsv
    # python3 cloudllm_inference.py --model gpt-4.1-2025-04-14 --t history --o datasets/manual/ad/history-cloud-gpt41.tsv
    # python3 cloudllm_inference.py --model o4-mini --t rewrite --o datasets/manual/ad/rewrite-cloud-o4-mini.tsv
    # python3 cloudllm_inference.py --model o4-mini --t history --o datasets/manual/ad/history-cloud-o4-mini.tsv
    # python3 cloudllm_inference_batch.py --model gemini-2.0-flash --t rewrite --o datasets/manual/rewrite-cloud-gemini2.tsv
    # python3 cloudllm_inference.py --model gpt-5-mini --t history --o datasets/result/history_complex_gpt5-mini.tsv
    data_files = {                
        'base': [            
            'datasets/tc/rewrited/it2_NR_tc.tsv',
            # 'datasets/tc/rewrited/it2_nonNR_tc.tsv',
            # 'datasets/tc/rewrited/it3_nonNR_tc.tsv',
            # 'datasets/tc/rewrited/it4_nonNR_tc.tsv',
            # 'datasets/tc/rewrited/it5_nonNR_tc.tsv',            
        ],   
        'manual': [                     
        ...
        'complex': [                        
            'datasets/tc/rewrited/it3_complex_1_tc.tsv',
            'datasets/tc/rewrited/it4_complex_1_tc.tsv',
            'datasets/tc/rewrited/it4_complex_2_tc.tsv',
            'datasets/tc/rewrited/it5_complex_1_tc.tsv',
            'datasets/tc/rewrited/it5_complex_2_tc.tsv',
            'datasets/tc/rewrited/it5_complex_3_tc.tsv',                    
        ],                                 
    }        
