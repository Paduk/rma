...
def run_llama_profile(args):
    ...
    callbacks = []
    if args.epoch_eval_path:
        print(
            "[epoch_eval] skipped for llama profile because it still uses legacy "
            "manual prompt templates. Use --profile generic for chat-template epoch eval."
        )
