MODEL="gpt-5-mini" # o4-mini-2025-04-16
#DATADIR="o4_datagen"
DATADIR="gpt5-mini"
...
python3 batch_s3_rewriter.py --s ${DATADIR}/it1_s3_idxed_dedup.jsonl --o ${DATADIR}/it1_s3_idxed_rewrite.jsonl --model $MODEL &&
...
python3 batch_s3_rewriter.py --s ${DATADIR}/it2_s3_idxed_dedup.jsonl --o ${DATADIR}/it2_s3_idxed_rewrite.jsonl --model $MODEL &&
...
python3 batch_s3_rewriter.py --s ${DATADIR}/it3_s3_idxed_dedup.jsonl --o ${DATADIR}/it3_s3_idxed_rewrite.jsonl --model $MODEL &&
...
python3 batch_s3_rewriter.py --s ${DATADIR}/it4_s3_idxed_dedup.jsonl --o ${DATADIR}/it4_s3_idxed_rewrite.jsonl --model $MODEL &&
